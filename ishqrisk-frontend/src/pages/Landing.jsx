...
export default function Landing() {
  return (
    <div className="relative min-h-screen overflow-hidden bg-reference">
      ...
      {/* Left ambient spine */}
      <div className="pointer-events-none absolute left-8 top-0 h-full w-px bg-white/10" />

      {/* Decorative hearts (reference-style) */}
      ...
      <section className="min-h-screen flex items-center justify-center px-6">
        <div className="max-w-3xl text-center mt-24">
          ...
          <p className="text-white/65 text-base md:text-lg mb-10">
            No photos. No superficial judgments. <br />
            Just two people talking — and seeing where it goes.
          </p>

          {/* CTAs */}
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button className="bg-[#D8A7B1] text-black font-semibold px-8 py-3 rounded-full hover:scale-[1.04] hover:shadow-xl hover:shadow-[#D8A7B1]/30 transition-all duration-300">
              Start a Blind Date →
            </button>

            <button className="border border-white/20 text-white px-8 py-3 rounded-full hover:bg-white/5 hover:scale-[1.02] transition-all duration-300">
              See How It Works
            </button>
          </div>
        </div>
