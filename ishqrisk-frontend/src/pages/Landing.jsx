      ...
      <section className="min-h-screen flex items-center justify-center px-4 sm:px-6">
        <div className="max-w-3xl text-center mt-24 relative z-10">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button
              onClick={signIn}
              className="bg-[#D8A7B1] text-black font-semibold px-8 py-4 sm:py-3 rounded-full hover:scale-[1.04] hover:shadow-xl hover:shadow-[#D8A7B1]/30 transition-all duration-300"
            >
              Start a Blind Date →
            </button>
